<template>
  <div class="space-y-8 animate-in fade-in duration-500">
     <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
        <div class="space-y-6">
           <div class="space-y-2">
              <label class="text-[10px] font-bold text-white/60 uppercase tracking-widest ml-1">Nome do Sistema</label>
              <input 
                type="text" 
           ...
           <div class="space-y-2">
              <label class="text-[10px] font-bold text-white/60 uppercase tracking-widest ml-1">Cor Principal (Azul)</label>
         ...
         <div class="space-y-6">
           <!-- Logo Upload -->
           <div class="space-y-3">
              <label class="text-[10px] font-bold text-white/60 uppercase tracking-widest ml-1 flex items-center gap-2">
              ...
              <div class="flex items-center gap-6 p-4 bg-white/5 border border-white/10 rounded-3xl group">
                 <div class="w-16 h-16 rounded-2xl bg-[#080809] border border-white/5 flex items-center justify-center p-2 overflow-hidden shadow-inner">
                    ...
                    <div v-else class="text-[10px] font-bold text-white/30 uppercase italic">LOGO</div>
                 </div>
                 ...
                 <div class="flex-1 space-y-2">
                    <label class="inline-flex items-center px-4 py-2 bg-kros-blue/10 hover:bg-kros-blue/20 border border-kros-blue/20 rounded-xl cursor-pointer transition-all">
                       <span class="text-[9px] font-bold text-kros-blue uppercase tracking-widest">Escolher Arquivo</span>
                       <input 
                         type="file" 
                    ...
                    <p class="text-[9px] text-white/50 font-medium uppercase leading-tight">Recomendado: 512x512px <br/> Formatos: PNG ou SVG</p>
                 </div>
              </div>
           </div>
           ...
           <div class="space-y-3">
              ...
              <div class="flex items-center gap-6 p-4 bg-white/5 border border-white/10 rounded-3xl">
                 <div class="w-16 h-16 rounded-2xl bg-[#080809] border border-white/5 flex items-center justify-center p-4 overflow-hidden shadow-inner">
                    ...
                    <div v-else class="text-[10px] font-bold text-white/30 uppercase italic">PNG</div>
                 </div>
                 ...
                 <div class="flex-1 space-y-2">
                    <label class="inline-flex items-center px-4 py-2 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl cursor-pointer transition-all">
                       <span class="text-[9px] font-bold text-white/60 uppercase tracking-widest">Escolher Ícone</span>
                       <input 
                         type="file" 
                    ...
                    <p class="text-[9px] text-white/50 font-medium uppercase leading-tight">Recomendado: 32x32px <br/> Formato: PNG ou ICO</p>
                 </div>
              </div>
           </div>
        </div>
      ...
      <div class="pt-8 border-t border-white/5 flex gap-4 items-center justify-between mt-4">
         ...
         <button 
           ...
           :disabled="loading"
           class="btn-primary px-10 py-4 rounded-2xl text-[10px] font-bold uppercase tracking-[0.2em] transition-all disabled:opacity-50 shadow-[0_10px_30px_rgba(var(--kros-blue-rgb),0.3)]"
         >
