  ...
  <div v-if="isOpen" :class="[
    ...
    ></div>
      ...
      <div :class="[
        ...
        <!-- Header Compacto (Minimizado) -->
        <div v-if="isMinimized" class="flex items-center justify-between mb-4">
           <div class="flex items-center gap-3">
              <div class="w-8 h-8 bg-kros-blue/10 rounded-xl flex items-center justify-center text-kros-blue border border-kros-blue/20">
              ...
              <div class="overflow-hidden">
                 <p class="text-xs font-black text-white uppercase tracking-wider truncate">
                   {{ currentCompanyName || 'Campanha Ativa' }}
                 </p>
                 <p class="text-[10px] text-white/50 uppercase font-bold">{{ progress }} de {{ payments.length }} envios</p>
              </div>
           </div>
           <button @click="isMinimized = false" class="p-2 hover:bg-white/5 rounded-lg text-white/40 hover:text-white transition-all">
