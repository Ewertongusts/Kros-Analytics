    ...
    <div @click="$emit('close')" class="absolute inset-0 bg-black/90 backdrop-blur-xl"></div>
      ...
      <div class="relative bg-[#0D0D0E] border border-white/10 rounded-[2.5rem] w-full max-w-md p-6 overflow-hidden shadow-[0_0_100px_rgba(0,0,0,0.8)]">
        <div class="mb-3 text-center relative z-10">
          <div class="w-10 h-10 bg-emerald-500/10 rounded-xl flex items-center justify-center text-emerald-500 mx-auto mb-2 border border-emerald-500/20 shadow-[0_0_20px_rgba(16,185,129,0.1)]">
          ...
          <h3 class="text-base font-black italic uppercase tracking-tighter text-white leading-none">
      ...
      <form v-else @submit.prevent="handleSend" class="space-y-4 relative z-10">
        ...
        <div class="flex gap-3 pt-3 border-t border-white/5">
          <button 
            type="button"
            @click="$emit('close')"
            class="flex-1 py-3 text-[10px] font-black uppercase tracking-widest text-white/20 hover:text-white hover:bg-white/5 rounded-xl transition-all"
          >
            Sair
          </button>
          <button 
            ...
            class="flex-[2] btn-primary py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all disabled:opacity-50 flex items-center justify-center gap-2"
          >
            ...
            <span v-else>Enviar Cobrança</span>
          </button>
        </div>
