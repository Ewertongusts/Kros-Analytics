<template>
  <div class="relative">
    <button 
      @click="isOpen = !isOpen"
      :disabled="disabled"
      class="p-2.5 bg-white/5 hover:bg-white/10 text-white/30 hover:text-white rounded-xl transition-all border border-transparent hover:border-white/10 disabled:opacity-50 disabled:cursor-not-allowed"
      :title="disabled ? 'Nenhum dado para exportar' : 'Exportar Dados'"
