-- PASSO 1: Adicionar user_id na tabela transactions (sem constraint ainda)
ALTER TABLE transactions 
ADD COLUMN IF NOT EXISTS user_id UUID;

-- PASSO 2: Adicionar outros campos na tabela transactions
ALTER TABLE transactions 
...
-- PASSO 3: Criar tabela expense_categories
